...
function Focus() {
    ...
    return (
        <section className='focus'>
            ...
            <h2 data-aos='fade-up'>FINANCE AT YOUR FINGERTIPS</h2>
            <p className='focus__p' data-aos='fade-up'>Follow our straightforward approach to learning.</p>
            <div className='focus__instructions' data-aos='fade-up'>
                <div className='focus__instructions--single'>
